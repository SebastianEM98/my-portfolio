    ...
    <section id="contact" className="section-padding">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <AnimatedSection delay={0.3}>
                <a href="mailto:sebastianecheverri.dev@gmailink.com" className="inline-flex items-center justify-center gap-2 whitespace-nowrap h-12 px-8 text-base font-medium rounded-xl bg-primary text-primary-foreground shadow-lg shadow-primary/30 hover:bg-primary/90 hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-200">
