                    ...
                    <AnimatedSection key={project.title} delay={i * 0.08}>
                        <div className="glass rounded-2xl p-6 md:p-8 group hover:border-primary/20 transition-all duration-300 glow-border">
                            ...
                            <div className="flex gap-3 mt-6 pt-5 border-t border-border/50">
                                <a href={project.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 whitespace-nowrap h-9 px-3 rounded-md text-sm font-medium transition-all duration-200 hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
